...
- [Log Record Structure](doc/message-structure.md) 日志记录结构
...
- 框架和库实现了php-fig规定的日志规范PSR-3接口，能够非常容易的使用Monolog
...
Python's [Logbook](http://packages.python.org/Logbook/)极大的影响了Monogo，这些思想大量的被修改以适应PHP